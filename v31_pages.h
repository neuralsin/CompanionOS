...
// ΓöÇΓöÇ State Trackers for Spotify ΓöÇΓöÇ
...
void redrawSpotifyPartial() {
  ...
  // ΓöÇΓöÇ LEFT COLUMN: Album Art + Track Info ΓöÇΓöÇ
  ...
  // ΓöÇΓöÇ CENTER COLUMN: Playback Controls ΓöÇΓöÇ
  ...
  if (!controlsDrawn) {
    ...
    // Main Row: Prev, (Play/Pause is drawn below), Next  ΓÇö Wide spacing
  ...
  // ΓöÇΓöÇ CENTER COLUMN: Progress Bar + Waveform Pulse ΓöÇΓöÇ
  ...
  // ΓöÇΓöÇ RIGHT COLUMN: Lyrics Card ΓöÇΓöÇ
  int cardX = 210;
  int cardY = 25;
  int cardW = 105;
  int cardH = 190;
